...
#---Selection button-
def select(x,y,w,h,option,place,a,b,action=None):
    mouse=pygame.mouse.get_pos()
    click=pygame.mouse.get_pressed()
...
def chairselection():
    ...
    while chairselects:
        ...
        select(297,375,19,70,chairselection1,chair1,100,150,chairplacing)
        select(375,454,20,70,chairselection2,chair2,100,100,chairplacing)
