...
#---Selection button-
def select(x,y,w,h,option,a,b,image,action=None):
    mouse=pygame.mouse.get_pos()
    click=pygame.mouse.get_pressed()
...
def chairselection():
    ...
    while chairselects:
        ...
        select(297,19,375,70,chairselection1, 140,160, chair1, placefurniture)
        select(375,20,454,70,chairselection2, 140,160, chair2, placefurniture)
